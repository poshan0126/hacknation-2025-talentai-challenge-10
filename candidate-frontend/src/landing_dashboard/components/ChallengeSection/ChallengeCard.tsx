        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ 
            ...
            <ul style={{ margin: 0, paddingLeft: '1.25rem', fontSize: '0.875rem', lineHeight: '1.6' }}>
              <li>AI-generated challenges based on YOUR skills</li>
              <li>Language selection from your technical stack</li>
              <li>Difficulty tailored to your experience level</li>
